...
def _create_links_roads(pre_road,suc_road,same_type=''):
    ...
    if same_type != '':
        ...
        print(str(len(pre_road.lanes.lanesections[pre_connecting_lanesec].leftlanes)) +"   "+ str(len(suc_road.lanes.lanesections[-1].leftlanes)))
        print(str(len(pre_road.lanes.lanesections[pre_connecting_lanesec].rightlanes)) +"   "+ str(len(suc_road.lanes.lanesections[-1].rightlanes)))

        for i in range(min(len(pre_road.lanes.lanesections[pre_connecting_lanesec].leftlanes),
                           len(suc_road.lanes.lanesections[-1].leftlanes))):
        ...
        for i in range(min(len(pre_road.lanes.lanesections[pre_connecting_lanesec].rightlanes),
                           len(suc_road.lanes.lanesections[-1].rightlanes))):
